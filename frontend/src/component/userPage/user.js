...
function UserPage() {
    ...
    const HandleFindUserfunc = (searchQuery, users) => {
        ...
        if (!searchQuery || typeof searchQuery !== 'string') {
            console.error('Query is empty or not a string.');
            return TeamMembers;
        }
    ...
    const filteredUsers = HandleFindUserfunc(searchQuery, users);
    ...
    return (
        <>
            ...
            <Grid container spacing={2} columns={16}>
                <Grid item xs={8} >
                    <Item style={{ boxShadow: "none", textAlign: "left", }}>
                        <input onChange={HandleFindUser} value={searchQuery} id="userfullname" type="text" placeholder="Search user" name="userfullname" role="search" style={{ textAlign: "left", marginRight: "1rem", height: "26px", marginTop: "15px", marginLeft: "8px" }} />
                    </Item>
                </Grid>
                <Grid item xs={8}>
            ...
            {filteredUsers.length > 0 ? (
                // Show filtered users if there are results
